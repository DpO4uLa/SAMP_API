...
SAMP::classes::CObject *SAMP::classes::CObjectPool::Find(SAMP::classes::CObject *pGameObject) {
	return ((CObject *(__thiscall *)(CObjectPool *, SAMP::classes::CObject *))SAMP_ADDROF(0xF520))(this, pGameObject);
}

int SAMP::classes::CObjectPool::GetId(SAMP::classes::CObject *pObject) {
	return ((int(__thiscall *)(CObjectPool *, SAMP::classes::CObject *))SAMP_ADDROF(0xF560))(this, pObject);
}
