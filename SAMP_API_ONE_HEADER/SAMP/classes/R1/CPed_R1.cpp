...
SAMP::classes::CEntity *SAMP::classes::CPed::GetContactEntity() {
	return ((SAMP::classes::CEntity *(__thiscall *)(CPed *))SAMP_ADDROF(0xA8240))(this);
}

SAMP::classes::CVehicle *SAMP::classes::CPed::GetContactVehicle() {
	return ((SAMP::classes::CVehicle *(__thiscall *)(CPed *))SAMP_ADDROF(0xA8250))(this);
}
...
SAMP::classes::CPed *SAMP::classes::CPed::GetAimedPed() {
	return ((SAMP::classes::CPed *(__thiscall *)(CPed *))SAMP_ADDROF(0xA9800))(this);
}
...
SAMP::classes::CEntity *SAMP::classes::CPed::GetFloor() {
	return ((SAMP::classes::CEntity *(__thiscall *)(CPed *))SAMP_ADDROF(0xA72D0))(this);
}

SAMP::classes::CWeaponInfo *SAMP::classes::CPed::GetCurrentWeaponInfo() {
	return ((SAMP::classes::CWeaponInfo *(__thiscall *)(CPed *))SAMP_ADDROF(0xA7380))(this);
}
...
SAMP::classes::CWeapon *SAMP::classes::CPed::GetWeaponSlot(int nWeapon) {
	return ((SAMP::classes::CWeapon *(__thiscall *)(CPed *, int))SAMP_ADDROF(0xA7A50))(this, nWeapon);
}
