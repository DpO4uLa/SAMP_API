...
SAMP::classes::ID SAMP::classes::CVehiclePool::Find(SAMP::classes::CVehicle *pGameObject) {
	return ((ID(__thiscall *)(CVehiclePool *, SAMP::classes::CVehicle *))SAMP_ADDROF(0x1B0A0))(this, pGameObject);
}
...
SAMP::classes::GTAREF SAMP::classes::CVehiclePool::GetRef(SAMP::classes::CVehicle *pGameObject) {
	return ((GTAREF(__thiscall *)(CVehiclePool *, SAMP::classes::CVehicle *))SAMP_ADDROF(0x1B0F0))(this, pGameObject);
}
