...
SAMP::classes::ID SAMP::classes::CPlayerPool::Find(SAMP::classes::CPed *pPed) {
	return ((ID(__thiscall *)(CPlayerPool *, SAMP::classes::CPed *))SAMP_ADDROF(0x10420))(this, pPed);
}
...
SAMP::classes::CObject *SAMP::classes::CPlayerPool::FindAccessory(SAMP::classes::CObject *pGameObject) {
	return ((CObject *(__thiscall *)(CPlayerPool *, SAMP::classes::CObject *))SAMP_ADDROF(0x106A0))(this, pGameObject);
}
