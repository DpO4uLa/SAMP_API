...
SAMP::classes::CObject::CObject(int nModel, CVector position, CVector rotation, float fDrawDistance, int a10, char a11, char a12) {
...
void SAMP::classes::CObject::SetRotation(const CVector *pVector) {
...
void SAMP::classes::CObject::Rotate(CVector vector) {
...
void SAMP::classes::CObject::Process(float fElapsedTime) {
