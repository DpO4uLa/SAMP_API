...
void SAMP::classes::CLocalPlayer::SetSpecialAction(char nId) {
...
void SAMP::classes::CLocalPlayer::SetColor(D3DCOLOR color) {
...
void SAMP::classes::CLocalPlayer::SpectateForVehicle(ID nId) {
	((void(__thiscall *)(CLocalPlayer *, ID))SAMP_ADDROF(0x4080))(this, nId);
}

void SAMP::classes::CLocalPlayer::SpectateForPlayer(ID nId) {
...
void SAMP::classes::CLocalPlayer::UpdateCameraTarget() {
...
void SAMP::classes::CLocalPlayer::RequestClass(int nId) {
