...
int &SAMP::classes::Exception::nCount = *(int *)SAMP_ADDROF(0x1118B0);
void *&SAMP::classes::Exception::pContextRecord = *(void **)SAMP_ADDROF(0x10D8A8);
char *SAMP::classes::Exception::szCrashDialogText = (char *)SAMP_ADDROF(0x10D8B0);
