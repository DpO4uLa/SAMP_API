...
#define SAMP_BEGIN_NP namespace SAMP { namespace classes {
#define SAMP_END_NP }}

#define SAMP_BEGIN __pragma(pack(push, 1)) namespace SAMP {  namespace classes {
#define SAMP_END }} __pragma(pack(pop))

#define SAMP_ADDROF(_OFFSET) (SAMP::classes::GetHandle() + _OFFSET)
